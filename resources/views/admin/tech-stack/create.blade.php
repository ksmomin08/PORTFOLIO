    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="m-0 text-primary">Add Technology / Skill</h5>
                <a href="{{ route('admin.tech-stack.index') }}" class="btn btn-sm btn-outline-secondary"><i class="fa-solid fa-arrow-left me-1"></i> Back</a>
            </div>
            <div class="card-body">
                <form action="{{ route('admin.tech-stack.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="e.g. PHP, React, Flutter" required>
                                @error('name')
                            ...
                            <div class="card bg-light border-0 mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="icon" name="icon" value="{{ old('icon') }}" placeholder="fa-brands fa-html5">
                                    </div>
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="form-text small">If you upload an image, it will override the FontAwesome class choice. Maximum file size 1MB.</div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-end mt-4">
                        <button type="submit" class="btn btn-primary px-5"><i class="fa-solid fa-floppy-disk me-2"></i> Add Technology</button>
                    </div>
                </form>
            </div>
        </div>
