    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="m-0 text-primary">Create Blog Post</h5>
            ...
            <div class="card-body">
                <form action="{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" id="title" name="title" value="{{ old('title') }}" placeholder="e.g. 5 Design Trends to Watch in 2026" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="content_editor" name="content" rows="15">{{ old('content') }}</textarea>
                                @error('content')
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-text small text-muted">Recommend size: 800x500px. Max size 3MB.</div>
                                @error('thumbnail')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="tags" name="tags" value="{{ old('tags') }}" placeholder="Web, Design, PHP">
                            </div>
                            ...
                            <div class="card bg-light border-0 mb-3">
                                <div class="card-body">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="text" class="form-control" id="meta_title" name="meta_title" value="{{ old('meta_title') }}" placeholder="Custom browser tab title">
                                    </div>

                                    <div class="mb-2">
                                        <label for="meta_description" class="form-label small">Meta Description</label>
                                        <textarea class="form-control" id="meta_description" name="meta_description" rows="3" placeholder="Summary for search engines..."></textarea>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="text-end mt-4">
                        <button type="submit" class="btn btn-primary px-5"><i class="fa-solid fa-paper-plane me-2"></i> Save Post</button>
                    </div>
                </form>
            </div>
        </div>
